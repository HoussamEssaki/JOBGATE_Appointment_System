...
urlpatterns = [
    ...
    # Staff endpoints
    path('<int:university_id>/staff/', views.UniversityListCreateView.as_view(), name='staff-list-create'),
    path('<int:university_id>/staff/<int:staff_id>/', views.UniversityDetailView.as_view(), name='university-detail'),
