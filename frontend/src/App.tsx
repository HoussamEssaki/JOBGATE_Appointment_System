          ...
          <LocalizationProvider dateAdapter={AdapterDateFns}>
            ...
            <Routes>
              ...
              >
                ...
                <Route path="universities/agendas"        element={<ManageAgendasPage />} />
                <Route path="universities/agendas/create" element={<CreateAgendaPage />} />
                <Route path="universities/agendas/:id"    element={<AgendaDetailsPage />} />
                <Route path="universities/slots"          element={<ManageSlotsPage />} />

                {/* Admin screens */}
                <Route path="admin"                       element={<AdminDashboardPage />} />
                <Route path="admin/users"                 element={<UserManagementPage />} />
                <Route path="admin/universities"          element={<UniversityManagementPage />} />
                <Route path="admin/statistics"            element={<SystemStatisticsPage />} />
